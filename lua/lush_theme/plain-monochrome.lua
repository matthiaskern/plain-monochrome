...
-- Accent Colors
local main_blue = hsl("#B6D6FD")
local complement = hsl("#FDDDB6")
local gray = hsl("#202020") -- Or use hex form, preceeded with a #.
local white = hsl("#ffffff").darken(10)
...
local theme =
    ...
    function()
        return {
            ...
            Comment {fg = gray.lighten(10), gui = "italic"}, -- any comment
            ...
            SignColumn {bg = CursorLine.bg}, -- column where |signs| are displayed
            -- IncSearch    { }, -- 'incsearch' highlighting; also used for the text replaced with ":s///c"
            -- Substitute   { }, -- |:substitute| replacement text highlighting
            LineNr {fg = gray.lighten(30)}, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
            CursorLineNr {fg = gray.lighten(100), bg = CursorLine.bg}, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
            MatchParen {bg = Cursor.bg}, -- The character under the cursor or just before it, if it is a paired bracket, and its match. |pi_paren.txt|
            -- ModeMsg      { }, -- 'showmode' message (e.g., "-- INSERT -- ")
            -- MsgArea      { }, -- Area for messages and cmdline
            -- MsgSeparator { }, -- Separator for scrolled messages, `msgsep` flag of 'display'
            -- MoreMsg      { }, -- |more-prompt|
            NonText {fg = gray.lighten(10)}, -- '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line). See also |hl-EndOfBuffer|.
            -- Normal       { }, -- normal text
            ...
            Constant {fg = main_blue}, -- (preferred) any constant
